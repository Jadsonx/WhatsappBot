   ...
   public class Program
    {
        static void Main(string[] args)
        {
            ...
            string email = "jadson0102@live.com";
            string Assunto = "Meu Assunto";
            string json = "{\"status\": 2, \"priority\": 1, \"email\":\"jadson0102@live.com\",\"subject\":\"asdadasd\",\"description\":\"confirm adadsd received\"}";
